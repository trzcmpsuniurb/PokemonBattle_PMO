...
public class Stats implements IStats, Serializable {
	 ...
	 */
	public static Stats RandomStat() {
		Random rand=new Random();
		return new Stats(5+rand.nextInt(185),  5+rand.nextInt(245), 10+rand.nextInt(184), 20+rand.nextInt(230), 5+rand.nextInt(175), 25+rand.nextInt(200));
	}
	
	public Stats(int dmg, int def, int dmgspe, int defspe, int xpLevel, int pv) {
		this.dmg = dmg;
		this.def = def;
		this.dmgspe = dmgspe;
		this.defspe = defspe;
	...
	public String toString() {
		return "Stats [dmg=" + dmg + ", def=" + def + ", dmgspe=" + dmgspe + ", defspe=" + defspe
